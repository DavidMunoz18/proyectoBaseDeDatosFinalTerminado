...
<br> <br><br><br>
		<div id="invierno" class="container contrex">
			<div class="row justify-content-evenly">
				<div class="   col-lg-3 col-sm-3 col-3 border rounded" type="button">
				...
				<div class="fondonegro   col-lg-3 col-sm-3 col-3 border rounded" href="#" >
				...
				<div class="   col-lg-3 col-sm-3 col-3 border rounded" href="#" type="button">
		...
		<div class="container contrex">
			<div class="row justify-content-evenly">
				<div class="fondonegro   col-lg-3 col-sm-3 col-3 border rounded" type="button">
		...
		<div class="container contrex">
			<div class="row justify-content-evenly">
				...
				<div id="verano" class="   col-lg-3 col-sm-3 col-3 border rounded" href="#" type="button">
